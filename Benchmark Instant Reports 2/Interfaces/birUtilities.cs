    ...
    public class birUtilities
    {
        ...
        public static char calcLetterGrade(string testID, int numCorrect, int numTotalGiven, bool lookupTestInfo)
        {
            ...
            if (lookupTestInfo)
            {
                ...
                string q = Queries.GetNumTestQuestions.Replace("@testId", testID);
        ...
        public static string getSchoolTypeList(string schoolAbbr)
        {
            ...
            else
            {
                ...
                string qs = "select schoolid from " + DatabaseDefn.DBSchool + " " +
        ...
        public static DataView getAuthorizedCampusList(string username)
        {
            ...
            {
                ds = dbIFOracle.getDataRows(Queries.GetCampusList);
            }
            else
            {
                string qs = Queries.GetCampusInfoForCampus.Replace("@schoolAbbr", username);
