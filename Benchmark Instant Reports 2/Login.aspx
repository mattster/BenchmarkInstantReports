    ...
    <div id="loginformarea">
        ...
        <div class="row">
            ...
            <div class="formtextbox">
                <asp:TextBox ID="tbPasswordCampus" TextMode="Password" runat="server" Width="100px" /></div>
        </div>
        ...
        <div class="row">
            <div class="formlabel">
                Enter Password:</div>
            <div class="formtextbox">
                <asp:TextBox ID="tbPasswordAdmin" TextMode="Password" runat="server" Width="100px" /></div>
        </div>
        <div class="row">
            <asp:Button ID="btnSubmit" OnClick="Login_Click" Text="Login" runat="server" /></div>
    </div>
